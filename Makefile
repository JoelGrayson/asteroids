...
OTHER_SOURCES = maths.o asteroid.o rocket.o mechanics.o buttons.o bullets.o explosion.o score_and_lives.o audio/sounds.o saucer.o start_game_screen.o game_over_screen.o collision_detection.o
