...
#define __ROCKET_NUM_POINTS 5
extern int ROCKET_NUM_POINTS = __ROCKET_NUM_POINTS;
extern int ROCKET_EXPLODED_SIDES_NUM_POINTS = 0; // At the start, we don't want to draw the exploded rocket sides.
